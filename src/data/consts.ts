...
// TODO(micorix): Fill this
export const FB_PAGE_SLUG = "kolo.cybersec.wat";

// TODO(micorix): This email doesn't exist yet
export const CONTACT_EMAIL = "kolo.cybersecurity@wat.edu.pl";
