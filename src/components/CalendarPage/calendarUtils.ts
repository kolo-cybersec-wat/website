...
export const getInitialViewName = () => {
	...
	if (
		!Object.keys(VIEW_SEARCH_PARAM_TO_VIEW_NAME_MAPPING).includes(
			viewSearchParam,
		)
	)
...
export const setViewSearchParam = (viewName: string) => {
	...
	const newViewSearchParam = Object.keys(
		VIEW_SEARCH_PARAM_TO_VIEW_NAME_MAPPING,
