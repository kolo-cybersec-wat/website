...
export const createLinkedInCompanyProfileUrl = (slug: string) => `https://linkedin.com/company/${slug}`
export const createFacebookPageUrl = (slug: string) => `https://fb.com/${slug}`
